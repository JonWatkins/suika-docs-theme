...
function pageNavigation(context, props) {
  ...
  function finalizeLevel() {
    const built = typedoc_1.JSX.createElement(
      "ul",
      null,
      levels.pop().map((l) => typedoc_1.JSX.createElement("li", null, l))
    );
  ...
  for (const heading of props.pageHeadings) {
    ...
    levels[levels.length - 1].push(
      typedoc_1.JSX.createElement(
        "a",
        { href: heading.link, class: heading.classes },
        heading.kind && context.icons[heading.kind](),
        typedoc_1.JSX.createElement(
          "span",
          null,
          (0, utils_1.wbr)(heading.text)
        )
      )
    );
  }
  ...
  return typedoc_1.JSX.createElement(
    "details",
    { open: true, class: "tsd-index-accordion tsd-page-navigation" },
    typedoc_1.JSX.createElement(
      "summary",
    ...
    typedoc_1.JSX.createElement(
      ...
      typedoc_1.JSX.createElement(
        "ul",
        null,
        levels[0].map((l) => typedoc_1.JSX.createElement("li", null, l))
      )
    )
  );
}
