...
function navigation(context, props) {
  ...
  return typedoc_1.JSX.createElement(
    "nav",
    { class: "tsd-navigation" },
    link(props.project),
    typedoc_1.JSX.createElement(
      "ul",
      { class: "tsd-small-nested-navigation" },
      props.project.children?.map((c) =>
        typedoc_1.JSX.createElement("li", null, links(c))
      )
    )
  );
  function links(mod) {
    const children =
      (mod.kindOf(
        typedoc_1.ReflectionKind.SomeModule | typedoc_1.ReflectionKind.Project
      ) &&
        mod.children) ||
      [];
    const nameClasses = (0, utils_1.classNames)(
    ...
    return typedoc_1.JSX.createElement(
      ...
      typedoc_1.JSX.createElement(
        "div",
        { class: "tsd-accordion-details" },
        typedoc_1.JSX.createElement(
          "ul",
          { class: "tsd-nested-navigation" },
          children.map((c) => typedoc_1.JSX.createElement("li", null, links(c)))
        )
      )
    );
  }
